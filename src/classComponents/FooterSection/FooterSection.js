...
class FooterSection extends Component {
	render() {
		...
		let Account = ["Manage Your Apple ID", "Apple Store Account", "iCloud.com"];
		...
		let business = ["Apple and Business", "Shop for Business"];

		let Education = ["Apple and Education", "Shop for College"];
		...
		let Government = ["Apple and Education", "Shop for College"];
		let AppleValue = [
			"Find a Store",
			"Genius Bar",
			"Today at Apple",
					...
					<div className="container">
						...
						<div className="footer-links-wrapper row">
							<div className="links-wrapper-1 col-sm-12 col-md">
								...
								<FooterMap title="Shop and Learn" items={Shop1} />
							</div>
							<div className="links-wrapper-2 col-sm-12 col-md">
								...
								<FooterMap title="Shop and Learn" items={services} />
								...
								<FooterMap title="Account" items={Account} />
							</div>
							<div className="links-wrapper-3 col-sm-12 col-md">
								...
								<FooterMap title="Apple Store" items={AppleStore} />
							</div>
							<div className="links-wrapper-4 col-sm-12 col-md">
								<FooterMap title="for Business" items={business} />
								<FooterMap title="for Education" items={Education} />
								<FooterMap title="for Healthcare" items={Healthcare} />
								<FooterMap title="for Government" items={Government} />
							...
							// 	</ul> */}
								...
								<FooterMap title="Apple Value" items={AppleValue} />
								<FooterMap title="About Apple" items={AboutApple} />
							</div>
						</div>
